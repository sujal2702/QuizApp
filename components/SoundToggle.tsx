...
const SoundToggle: React.FC = () => {
  ...
  return (
    <button
      ...
      className="fixed bottom-4 left-4 z-40 p-3 rounded-full bg-zinc-800/80 hover:bg-zinc-700/80 border-2 border-zinc-700 transition-all hover:scale-110 shadow-lg backdrop-blur-sm"
